...
export default function EditCatalogueItemPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showSuccess('Catalogue item updated!');
            router.push('/admin/catalogue');
        } catch (error) {
    ...
    if (fetching) return <div className="p-8 text-gray-600">Loading item details...</div>;

    return (
        <div className="max-w-3xl mx-auto p-6">
            <h1 className="text-2xl font-bold font-serif text-slate-800 mb-6">Edit Catalogue Item</h1>
