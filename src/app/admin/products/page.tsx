...
export default function AdminProductsPage() {
    ...
    if (loading) return (
        <div className="p-8 text-slate-500 text-sm">Loading products…</div>
    );
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-5">
                <div>
                    <h1 className="text-xl font-bold text-slate-800">Products
                        <span className="ml-2 text-sm font-normal text-slate-400">(Retail)</span>
                    </h1>
                    <p className="text-xs text-slate-400 mt-0.5">{filtered.length} of {items.length} products</p>
                </div>
                <Link
