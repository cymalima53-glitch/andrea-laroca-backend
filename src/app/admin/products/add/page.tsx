...
export default function AddProductPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(err.msg || err.error || 'Failed to create product');
            }
    ...
    return (
        <div className="max-w-3xl mx-auto p-6">
            <h1 className="text-2xl font-bold font-serif text-slate-800 mb-6">Add New Product</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" required min="0" placeholder="999"
                            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-amber-500"
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" placeholder="item, lb, kg"
                            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-amber-500"
